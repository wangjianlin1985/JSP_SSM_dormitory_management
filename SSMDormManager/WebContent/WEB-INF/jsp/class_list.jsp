...
<c:forEach items="${ci.list}" var="ci">
        <tr>
            ...
            <td>
                <a title="编辑"    id= "updateEdit"    href="<%=request.getContextPath()%>/findClassById?c_id=${ci.c_id}">
...
<script>
    ...
    layui.use(['jquery', 'excel','form','layer','laydate'], function(){
        ...
        form.on('submit(toolbarDemo)', function(){
            ...
            $.ajax({
                url: '<%=request.getContextPath()%>/exportclasslist',
                type: 'post',
                dataType: 'json',
    ...
    function member_del(obj,c_id){
        layer.confirm('确认要删除吗？',function(index){
            //发异步删除数据
           $.get("<%=request.getContextPath()%>/deleteClass",{"c_id":c_id},function (data) {
                if(data =true){
