        ...
        <ul id="nav">
            ...
            <li>
                ...
                <ul class="sub-menu">
                    ...
                    <li>
                        <a _href="<%=request.getContextPath()%>/findClassStudent">
                            <%--点击在右侧出现动态的Tab--%>
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>班级学生</cite>
                        </a>
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a _href="<%=request.getContextPath()%>/findDormitory">
                            <%--点击在右侧出现动态的Tab--%>
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>宿舍列表</cite>
                        </a>
                ...
                <ul class="sub-menu">
                    <li>
                        <a _href="<%=request.getContextPath()%>/findDormitoryStudent">
                            <%--点击在右侧出现动态的Tab--%>
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>人员信息</cite>
                        </a>
                ...
                <ul class="sub-menu">
                    <li>
                        <a _href="<%=request.getContextPath()%>/findDormRepair">
                            <%--点击在右侧出现动态的Tab--%>
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>维修登记</cite>
                        </a>
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a _href="<%=request.getContextPath()%>/findDormClean">
                            <%--点击在右侧出现动态的Tab--%>
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>宿舍卫生</cite>
                        </a>
                ...
                <ul class="sub-menu">
                    <li>
                        <a _href="<%=request.getContextPath()%>/findStudentClean">
                            <%--点击在右侧出现动态的Tab--%>
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>学生卫生</cite>
                        </a>
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a _href="<%=request.getContextPath()%>/findVisitor">
                            <%--点击在右侧出现动态的Tab--%>
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>访客列表</cite>
                        </a>
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a _href="<%=request.getContextPath()%>/findAdmin">
                            <%--点击在右侧出现动态的Tab--%>
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>管理员列表</cite>
                        </a>
