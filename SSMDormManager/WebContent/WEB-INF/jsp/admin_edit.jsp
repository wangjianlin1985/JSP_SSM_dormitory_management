...
<head>
    ...
    <link rel="stylesheet"   <link rel="stylesheet" href="<%=request.getContextPath()%>/css/pg_btn.css">
...
<div class="x-body">
    ...
    <form class="layui-form"  id="f_auto" action="<%=request.getContextPath()%>/updateAdmin" method="post">
