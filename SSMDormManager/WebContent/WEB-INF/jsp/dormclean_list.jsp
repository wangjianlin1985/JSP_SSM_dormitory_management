...
<div class="x-nav">
      <span class="layui-breadcrumb">
        <a href="">首页</a>
        <a href="<%=request.getContextPath()%>/findDormClean">宿舍卫生</a>

      </span>
    <a class="layui-btn layui-btn-small" style="line-height:1.6em;margin-top:3px;float:right" href="<%=request.getContextPath()%>/findDormClean" title="刷新">
        <i class="layui-icon" style="line-height:30px">ဂ</i></a>
</div>
<div class="x-body">
    <div class="layui-row">
        <form class="layui-form layui-col-md12 x-so" action="<%=request.getContextPath()%>/findDormClean" >
    ...
    <table class="layui-table">
        ...
        <c:forEach items="${di.list}" var="di">
            <tr>
                ...
                <td>
                    <a title="编辑"    id= "updateEdit"    href="<%=request.getContextPath()%>/findDormCleanById?g_id=${di.g_id}">
    ...
    <script>
        ...
        layui.use(['jquery', 'excel','form','layer','laydate'], function(){
            ...
            form.on('submit(toolbarDemo)', function(){
                ...
                $.ajax({
                    url: '<%=request.getContextPath()%>/exportdormcleanlist',
                    type: 'post',
                    dataType: 'json',
                    ...
                    error: function () {
                        //console.log(data);
                        setTimeout(function () {window.location.href='<%=request.getContextPath()%>/findDormClean';},2000);
                    }
                });
            });
            ...
            $("#addStudnetBtn").click(function () {
                ...
                form.on('submit(formDemo)', function(data) {
                    ...
                    $.ajax({
                        url: '<%=request.getContextPath()%>/addDormClean',
                        type: "post",
        ...
        function member_del(obj,g_id){
            layer.confirm('确认要删除吗？',function(index){
                //发异步删除数据
                $.get("<%=request.getContextPath()%>/deleteDormClean",{"g_id":g_id},function (data) {
                    if(data =true){
