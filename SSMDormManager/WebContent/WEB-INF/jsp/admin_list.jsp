...
<head>
    ...
    <link rel="stylesheet"   <link rel="stylesheet" href="<%=request.getContextPath()%>/css/font.css">
    <link rel="stylesheet"   <link rel="stylesheet" href="<%=request.getContextPath()%>/css/xadmin.css">
...
<div class="x-nav">
      <span class="layui-breadcrumb">
        <a href="">首页</a>
        <a href="<%=request.getContextPath()%>/findAdmin">管理员信息</a>
      </span>
    <a class="layui-btn layui-btn-small" style="line-height:1.6em;margin-top:3px;float:right" href="<%=request.getContextPath()%>/findAdmin" title="刷新">
        <i class="layui-icon" style="line-height:30px">ဂ</i></a>
</div>
<div class="x-body">
    <div class="layui-row">
        <form class="layui-form layui-col-md12 x-so" action="<%=request.getContextPath()%>/findAdmin" >
...
<script>
    ...
    layui.use(['jquery', 'excel', 'form','layer','laydate'], function(){
        ...
        form.on('submit(toolbarDemo)', function(){
            ...
            $.ajax({
                url: '<%=request.getContextPath()%>/exportadminlist',
                type: 'post',
                dataType: 'json',
                ...
                success: function (data) {
                    ...
                    //setTimeout(function () {window.location.href='<%=request.getContextPath()%>/findAdmin';},2000);
                },
    ...
    $(".updateEdit").click(function () {
        ...
        if(admin_id != myid){
            ...
            <%--window.location.href = "<%=request.getContextPath()%>/findAdminById?a_id=${ai.a_id}";--%>
            window.location.href = "<%=request.getContextPath()%>/findAdminById?a_id=" + myid;
        }
    });
    ...
    function member_del(obj,a_id,a_power){
        ...
        // }
            ...
            layer.confirm('确认要删除吗？',function(index){
                //发异步删除数据
                $.get("<%=request.getContextPath()%>/deleteAdmin",{"a_id":a_id},function (data) {
                    if(data = true){
